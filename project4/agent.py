...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            # self.epsilon -= 0.05
            self.count += 1.0
            self.epsilon = math.cos(math.pi / 3000 *self.count)
            # self.epsilon = math.cos(math.pi / 2000 *self.count)
            # self.epsilon = math.cos(math.pi / 200 *self.count)
            # self.epsilon = 1.0/(self.count**2)
            # self.epsilon = math.cos(0.998*self.count) # tolerance 0.5 count 1500
